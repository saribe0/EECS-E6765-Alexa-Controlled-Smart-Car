...
import json
import os
import piCarCommands

# Prepare logging
if not os.path.exists("../logs"):
        os.makedirs("../logs")
logging.basicConfig(filename="../logs/mqtt.log", level=logging.DEBUG, format='%(asctime)s %(levelname)s> %(message)s')
...
def customCallback(client, userdata, message):
    ...
    # Log the incomming commands
    logging.debug("Received a new message: ")
    logging.debug(message.payload)
    logging.debug("from topic: ")
